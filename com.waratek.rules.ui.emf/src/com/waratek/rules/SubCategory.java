...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Sub Category</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see com.waratek.rules.RulesPackage#getSubCategory()
 * @model
 * @generated
 */
public enum SubCategory implements Enumerator
{
	/**
	 ...
	 * <!-- end-user-doc -->
	 * @see #THROW
	 * @model name="throw" literal="Throw"
	 * @generated
	 * @ordered
	 */
	 ...
	 * <!-- end-user-doc -->
	 * @see #LIBRARY
	 * @model name="library" literal="Library"
	 * @generated
	 * @ordered
	 */
	 ...
	 * <!-- end-user-doc -->
	 * @see #DATABASE
	 * @model name="database" literal="Database"
	 * @generated
	 * @ordered
	 */
	...
	/**
	 * An array of all the '<em><b>Sub Category</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final SubCategory[] VALUES_ARRAY =
		new SubCategory[]
		{
			CLASS,
			THROW,
	...
	/**
	 * A public read-only list of all the '<em><b>Sub Category</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<SubCategory> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Sub Category</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static SubCategory get(String literal)
	{
		for (int i = 0; i < VALUES_ARRAY.length; ++i)
		{
			SubCategory result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Sub Category</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	/**
	 * Returns the '<em><b>Sub Category</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	 ...
	 * @generated
	 */
	private SubCategory(int value, String name, String literal)
	{
		this.value = value;
		this.name = name;
