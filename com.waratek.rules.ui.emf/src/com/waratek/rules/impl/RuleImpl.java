...
public abstract class RuleImpl extends MinimalEObjectImpl.Container implements Rule {
	 ...
	 * @ordered
	 */
	protected static final Action ACTION_EDEFAULT = Action.DENY;
	 ...
	 * @ordered
	 */
	protected static final Log LOG_EDEFAULT = Log.WARN;
	 ...
	 * @ordered
	 */
	protected Log log = LOG_EDEFAULT;
	...
	public void setAction(Action newAction) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RulesPackage.RULE__ACTION, oldAction, action));
	}
	...
	public void setLog(Log newLog) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RulesPackage.RULE__LOG, oldLog, log));
	}
