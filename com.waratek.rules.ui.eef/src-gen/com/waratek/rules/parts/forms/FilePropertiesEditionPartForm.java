...
public class FilePropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, FilePropertiesEditionPart {
	...
	public void createControls(final FormToolkit widgetFactory, Composite view) {
		...
		propertiesStep.addStep(RulesViewsRepository.File.Properties.id);
		propertiesStep.addStep(RulesViewsRepository.File.Properties.comment);
		...
		composer = new PartComposer(fileStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == RulesViewsRepository.File.Properties.id) {
					return createIdText(widgetFactory, parent);
				}
				if (key == RulesViewsRepository.File.Properties.comment) {
	...
	protected Composite createIdText(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, RulesViewsRepository.File.Properties.id, RulesMessages.FilePropertiesEditionPart_IdLabel);
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							...
							RulesViewsRepository.File.Properties.id,
		...
		id.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(FilePropertiesEditionPartForm.this, RulesViewsRepository.File.Properties.id, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, id.getText()));
				}
			}
		});
		EditingUtils.setID(id, RulesViewsRepository.File.Properties.id);
		EditingUtils.setEEFtype(id, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(RulesViewsRepository.File.Properties.id, RulesViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createCommentText(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, RulesViewsRepository.File.Properties.comment, RulesMessages.FilePropertiesEditionPart_CommentLabel);
		...
		comment.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							FilePropertiesEditionPartForm.this,
							RulesViewsRepository.File.Properties.comment,
		...
		comment.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(FilePropertiesEditionPartForm.this, RulesViewsRepository.File.Properties.comment, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, comment.getText()));
				}
			}
		});
		EditingUtils.setID(comment, RulesViewsRepository.File.Properties.comment);
		EditingUtils.setEEFtype(comment, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(RulesViewsRepository.File.Properties.comment, RulesViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.waratek.rules.parts.FilePropertiesEditionPart#getId()
	 * 
	 */
	public String getId() {
		return id.getText();
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.waratek.rules.parts.FilePropertiesEditionPart#setId(String newValue)
	 * 
	 */
	public void setId(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(RulesViewsRepository.File.Properties.id);
		if (eefElementEditorReadOnlyState && id.isEnabled()) {
			id.setEnabled(false);
			id.setToolTipText(RulesMessages.File_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.waratek.rules.parts.FilePropertiesEditionPart#getComment()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.waratek.rules.parts.FilePropertiesEditionPart#setComment(String newValue)
	 * 
	 */
	public void setComment(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(RulesViewsRepository.File.Properties.comment);
		if (eefElementEditorReadOnlyState && comment.isEnabled()) {
			comment.setEnabled(false);
			comment.setToolTipText(RulesMessages.File_ReadOnly);
