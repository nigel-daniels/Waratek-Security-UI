 ...
 * 
 */
public class ReflectClassPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, ReflectClassPropertiesEditionPart {
	 ...
	 */
	public ReflectClassPropertiesEditionPartForm() { super(); }
	 ...
	 * 
	 */
	public ReflectClassPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
	...
	public void createControls(final FormToolkit widgetFactory, Composite view) {
		...
		propertiesStep.addStep(RulesViewsRepository.ReflectClass.Properties.id);
		propertiesStep.addStep(RulesViewsRepository.ReflectClass.Properties.comment);
		...
		composer = new PartComposer(reflectClassStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == RulesViewsRepository.ReflectClass.Properties.id) {
					return createIdText(widgetFactory, parent);
				}
				if (key == RulesViewsRepository.ReflectClass.Properties.comment) {
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(RulesMessages.ReflectClassPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createIdText(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, RulesViewsRepository.ReflectClass.Properties.id, RulesMessages.ReflectClassPropertiesEditionPart_IdLabel);
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							ReflectClassPropertiesEditionPartForm.this,
							RulesViewsRepository.ReflectClass.Properties.id,
		...
		id.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ReflectClassPropertiesEditionPartForm.this, RulesViewsRepository.ReflectClass.Properties.id, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, id.getText()));
				}
			}
		});
		EditingUtils.setID(id, RulesViewsRepository.ReflectClass.Properties.id);
		EditingUtils.setEEFtype(id, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(RulesViewsRepository.ReflectClass.Properties.id, RulesViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createCommentText(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, RulesViewsRepository.ReflectClass.Properties.comment, RulesMessages.ReflectClassPropertiesEditionPart_CommentLabel);
		...
		comment.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							ReflectClassPropertiesEditionPartForm.this,
							RulesViewsRepository.ReflectClass.Properties.comment,
		...
		comment.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ReflectClassPropertiesEditionPartForm.this, RulesViewsRepository.ReflectClass.Properties.comment, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, comment.getText()));
				}
			}
		});
		EditingUtils.setID(comment, RulesViewsRepository.ReflectClass.Properties.comment);
		EditingUtils.setEEFtype(comment, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(RulesViewsRepository.ReflectClass.Properties.comment, RulesViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createActionEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		...
		action.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ReflectClassPropertiesEditionPartForm.this, RulesViewsRepository.ReflectClass.Properties.action, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getAction()));
			}

		});
		action.setID(RulesViewsRepository.ReflectClass.Properties.action);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(RulesViewsRepository.ReflectClass.Properties.action, RulesViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createLogEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		...
		log.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ReflectClassPropertiesEditionPartForm.this, RulesViewsRepository.ReflectClass.Properties.log, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getLog()));
			}

		});
		log.setID(RulesViewsRepository.ReflectClass.Properties.log);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(RulesViewsRepository.ReflectClass.Properties.log, RulesViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createPackageNameText(FormToolkit widgetFactory, Composite parent) {
		...
		packageName.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							ReflectClassPropertiesEditionPartForm.this,
							RulesViewsRepository.ReflectClass.Properties.packageName,
		...
		packageName.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ReflectClassPropertiesEditionPartForm.this, RulesViewsRepository.ReflectClass.Properties.packageName, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, packageName.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(RulesViewsRepository.ReflectClass.Properties.packageName, RulesViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createClassNameText(FormToolkit widgetFactory, Composite parent) {
		...
		className.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							ReflectClassPropertiesEditionPartForm.this,
							RulesViewsRepository.ReflectClass.Properties.className,
		...
		className.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ReflectClassPropertiesEditionPartForm.this, RulesViewsRepository.ReflectClass.Properties.className, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, className.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(RulesViewsRepository.ReflectClass.Properties.className, RulesViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.waratek.rules.parts.ReflectClassPropertiesEditionPart#getId()
	 * 
	 */
	public String getId() {
		return id.getText();
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.waratek.rules.parts.ReflectClassPropertiesEditionPart#setId(String newValue)
	 * 
	 */
	public void setId(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(RulesViewsRepository.ReflectClass.Properties.id);
		if (eefElementEditorReadOnlyState && id.isEnabled()) {
			id.setEnabled(false);
			id.setToolTipText(RulesMessages.ReflectClass_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.waratek.rules.parts.ReflectClassPropertiesEditionPart#getComment()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.waratek.rules.parts.ReflectClassPropertiesEditionPart#setComment(String newValue)
	 * 
	 */
	public void setComment(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(RulesViewsRepository.ReflectClass.Properties.comment);
		if (eefElementEditorReadOnlyState && comment.isEnabled()) {
			comment.setEnabled(false);
			comment.setToolTipText(RulesMessages.ReflectClass_ReadOnly);
