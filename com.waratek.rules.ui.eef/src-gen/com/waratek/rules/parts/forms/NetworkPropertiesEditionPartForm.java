...
public class NetworkPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, NetworkPropertiesEditionPart {
	...
	public void createControls(final FormToolkit widgetFactory, Composite view) {
		...
		propertiesStep.addStep(RulesViewsRepository.Network.Properties.id);
		propertiesStep.addStep(RulesViewsRepository.Network.Properties.comment);
		...
		composer = new PartComposer(networkStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == RulesViewsRepository.Network.Properties.id) {
					return createIdText(widgetFactory, parent);
				}
				if (key == RulesViewsRepository.Network.Properties.comment) {
	...
	protected Composite createIdText(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, RulesViewsRepository.Network.Properties.id, RulesMessages.NetworkPropertiesEditionPart_IdLabel);
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							...
							RulesViewsRepository.Network.Properties.id,
		...
		id.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NetworkPropertiesEditionPartForm.this, RulesViewsRepository.Network.Properties.id, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, id.getText()));
				}
			}
		});
		EditingUtils.setID(id, RulesViewsRepository.Network.Properties.id);
		EditingUtils.setEEFtype(id, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(RulesViewsRepository.Network.Properties.id, RulesViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createCommentText(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, RulesViewsRepository.Network.Properties.comment, RulesMessages.NetworkPropertiesEditionPart_CommentLabel);
		...
		comment.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							NetworkPropertiesEditionPartForm.this,
							RulesViewsRepository.Network.Properties.comment,
		...
		comment.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NetworkPropertiesEditionPartForm.this, RulesViewsRepository.Network.Properties.comment, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, comment.getText()));
				}
			}
		});
		EditingUtils.setID(comment, RulesViewsRepository.Network.Properties.comment);
		EditingUtils.setEEFtype(comment, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(RulesViewsRepository.Network.Properties.comment, RulesViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.waratek.rules.parts.NetworkPropertiesEditionPart#getId()
	 * 
	 */
	public String getId() {
		return id.getText();
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.waratek.rules.parts.NetworkPropertiesEditionPart#setId(String newValue)
	 * 
	 */
	public void setId(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(RulesViewsRepository.Network.Properties.id);
		if (eefElementEditorReadOnlyState && id.isEnabled()) {
			id.setEnabled(false);
			id.setToolTipText(RulesMessages.Network_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.waratek.rules.parts.NetworkPropertiesEditionPart#getComment()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.waratek.rules.parts.NetworkPropertiesEditionPart#setComment(String newValue)
	 * 
	 */
	public void setComment(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(RulesViewsRepository.Network.Properties.comment);
		if (eefElementEditorReadOnlyState && comment.isEnabled()) {
			comment.setEnabled(false);
			comment.setToolTipText(RulesMessages.Network_ReadOnly);
