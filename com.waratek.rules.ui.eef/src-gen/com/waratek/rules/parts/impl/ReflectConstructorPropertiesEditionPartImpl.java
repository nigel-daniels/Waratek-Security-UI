...
public class ReflectConstructorPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, ReflectConstructorPropertiesEditionPart {
	...
	protected Composite createIdText(Composite parent) {
		...
		id.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ReflectConstructorPropertiesEditionPartImpl.this, RulesViewsRepository.ReflectConstructor.Properties.id, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, id.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(RulesViewsRepository.ReflectConstructor.Properties.id, RulesViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createCommentText(Composite parent) {
		...
		comment.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ReflectConstructorPropertiesEditionPartImpl.this, RulesViewsRepository.ReflectConstructor.Properties.comment, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, comment.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(RulesViewsRepository.ReflectConstructor.Properties.comment, RulesViewsRepository.SWT_KIND), null); //$NON-NLS-1$
