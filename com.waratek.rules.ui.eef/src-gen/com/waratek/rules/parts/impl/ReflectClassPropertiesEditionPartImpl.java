...
public class ReflectClassPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, ReflectClassPropertiesEditionPart {
	...
	protected Composite createIdText(Composite parent) {
		...
		id.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ReflectClassPropertiesEditionPartImpl.this, RulesViewsRepository.ReflectClass.Properties.id, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, id.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(RulesViewsRepository.ReflectClass.Properties.id, RulesViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createCommentText(Composite parent) {
		...
		comment.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ReflectClassPropertiesEditionPartImpl.this, RulesViewsRepository.ReflectClass.Properties.comment, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, comment.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(RulesViewsRepository.ReflectClass.Properties.comment, RulesViewsRepository.SWT_KIND), null); //$NON-NLS-1$
