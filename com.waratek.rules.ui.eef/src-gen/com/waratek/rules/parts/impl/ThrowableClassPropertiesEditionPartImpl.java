...
public class ThrowableClassPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, ThrowableClassPropertiesEditionPart {
	...
	protected Composite createIdText(Composite parent) {
		...
		id.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ThrowableClassPropertiesEditionPartImpl.this, RulesViewsRepository.ThrowableClass.Properties.id, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, id.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(RulesViewsRepository.ThrowableClass.Properties.id, RulesViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createCommentText(Composite parent) {
		...
		comment.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ThrowableClassPropertiesEditionPartImpl.this, RulesViewsRepository.ThrowableClass.Properties.comment, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, comment.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(RulesViewsRepository.ThrowableClass.Properties.comment, RulesViewsRepository.SWT_KIND), null); //$NON-NLS-1$
