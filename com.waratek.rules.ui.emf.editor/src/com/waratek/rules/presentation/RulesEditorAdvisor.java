 ...
 * @generated
 */
public final class RulesEditorAdvisor extends WorkbenchAdvisor {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @generated
	 */
	private static final String[] FILE_EXTENSION_FILTERS = RulesEditor.FILE_EXTENSION_FILTERS.toArray(new String[0]); 
	...
	private static String getString(String key, Object s1) {
		return com.waratek.rules.presentation.RulesEditorPlugin.INSTANCE.getString(key, new Object [] { s1 });
	}
	...
	public static class Application implements IApplication {
		...
		public Object start(IApplicationContext context) throws Exception {
			WorkbenchAdvisor workbenchAdvisor = new RulesEditorAdvisor();
	...
	public static class Perspective implements IPerspectiveFactory {
		 ...
		 * @generated
		 */
		public static final String ID_PERSPECTIVE = "com.waratek.rules.presentation.RulesEditorAdvisorPerspective";
		 ...
		 * @generated NOT
		 */
		// MOD Updated to just have the editor space and the properties
		public void createInitialLayout(IPageLayout layout) {
			layout.setEditorAreaVisible(true);
			layout.addPerspectiveShortcut(ID_PERSPECTIVE);

			//IFolderLayout bottom = layout.createFolder("top", IPageLayout.TOP, (float)0.66, layout.getEditorArea());
	...
	public static class WindowActionBarAdvisor extends ActionBarAdvisor {
		...
		protected IMenuManager createHelpMenu(IWorkbenchWindow window) {
			...
			// MOD Added in the standard help menu items
	...
	/**
	 * Open action for the objects from the Rules model.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	/**
	 * Open URI action for the objects from the Rules model.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
