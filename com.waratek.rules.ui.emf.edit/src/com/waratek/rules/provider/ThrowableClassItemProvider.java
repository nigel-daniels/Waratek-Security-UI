 ...
 * @generated
 */
public class ThrowableClassItemProvider
	 ...
	 * @generated
	 */
	public ThrowableClassItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ThrowableClass_className_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ThrowableClass_className_feature", "_UI_ThrowableClass_type"),
				 RulesPackage.Literals.THROWABLE_CLASS__CLASS_NAME,
				 true,
				 false,
				 false,
	...
	/**
	 * This returns ThrowableClass.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ThrowableClass"));
	}
	...
	public String getText(Object object) {
		...
		label.append(throwableClass.getId() + " - ");
		label.append(throwableClass.getClassName() + ":" + throwableClass.getAction().toString() + ":" + throwableClass.getLog().toString());
		
		if (throwableClass.getComment() != null)
			if (!throwableClass.getComment().isEmpty())
				{label.append(" - " + throwableClass.getComment());}
