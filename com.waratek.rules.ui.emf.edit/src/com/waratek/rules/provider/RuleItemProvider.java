...
/**
 * This is the item provider adapter for a {@link com.waratek.rules.Rule} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RuleItemProvider
	extends LinesItemProvider
	implements
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RulesPackage.Literals.RULE__ACTION,
				 true,
				 false,
				 false,
	...
	protected void addLogPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Rule_log_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Rule_log_feature", "_UI_Rule_type"),
				 RulesPackage.Literals.RULE__LOG,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
